...
In this section, we will primarily focus on establishing a model using the Gated Recurrent Unit (GRU) network to 
...
\begin{itemize}
    ...
    \item Utilizing Gated Recurrent Unit (GRU)
\end{itemize}
...
\begin{figure}[H]
    \centering
        \includegraphics[width=\linewidth]{mainmatter/photos/states.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.34\textwidth}
        \includegraphics[width=\linewidth]{mainmatter/photos/swing_match1.png}
        \caption{swings in match 1}
    \end{subfigure}\hspace{-0.02\textwidth}
    \begin{subfigure}[b]{0.34\textwidth}
        \includegraphics[width=\linewidth]{mainmatter/photos/swing_match2.png}
        \caption{swings in match 2}
    \end{subfigure}\hspace{-0.02\textwidth}
    \begin{subfigure}[b]{0.34\textwidth}
        \includegraphics[width=\linewidth]{mainmatter/photos/swing_match3.png}
